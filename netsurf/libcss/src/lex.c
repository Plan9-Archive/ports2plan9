 ...
 */ /* find String css_lexer css_token Plan9 */
...
/* compilation on Plan9 complained about redefinition of String here */
	...
	string:
		...
		if (error == CSS_INVALID) { 
			...
			return error;
		} /* another String-related error while compiling on Plan9 */
