...
/* local modification to get this thing to build  on Plan9 */
#define MKSH_BUILD_R 406
/* ok we do not have mkstemp but we do have mktemp - can it be used? */
#define seteuid setuid
#define setegid setgid
#define tempnam tmpnam

/* end of Plan9 hackery */
