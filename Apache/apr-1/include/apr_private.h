...
#define GETSERVBYNAME_IS_THREAD_SAFE
...
#undef HAVE_STDINT_H /* redundant with inttypes.h */
...
#define PACKAGE_NAME "Apache Portable Runtime"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "1.4.5"
