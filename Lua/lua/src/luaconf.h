...
** See Copyright Notice in lua.h LUA_LDIR
*/
...
#define LUA_ROOT	"/"
#define LUA_LDIR	LUA_ROOT "sys/share/lua/" LUA_VDIR
#define LUA_CDIR	LUA_ROOT "$M/lib/ape/lua/" LUA_VDIR
#define LUA_PATH_DEFAULT  \
		LUA_LDIR"?.lua;"  LUA_LDIR"?/init.lua;" \
		LUA_CDIR"?.lua;"  LUA_CDIR"?/init.lua;" "./?.lua"
#define LUA_CPATH_DEFAULT \
		LUA_CDIR"?.a;" LUA_CDIR"loadall.a;" "./?.a"
#endif			/* } */
