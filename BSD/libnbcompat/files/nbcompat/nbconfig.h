/* nbcompat/config.h.  Generated from config.h.in by configure. statfs */
...
/* ok I want them built into the library... so I should define them? */
/* took the information from config.log */
...
/* assumes that heirloom libuxre is installed */
#ifndef HAVE_REGEX_H
...
#ifndef HAVE_STRUCT_STATFS_F_FLAGS
#define HAVE_STRUCT_STATFS_F_FLAGS 0
#endif

/* Define to 1 if `f_fsize' is a member of `struct statfs'. */
#ifndef HAVE_STRUCT_STATFS_F_FSIZE
#define HAVE_STRUCT_STATFS_F_FSIZE 0
#endif

/* Define to 1 if `f_iosize' is a member of `struct statfs'. */
#ifndef HAVE_STRUCT_STATFS_F_IOSIZE
#define HAVE_STRUCT_STATFS_F_IOSIZE 0
#endif
...
/* #define PACKAGE_URL www.pkgsrc.org */
...
#define FD_SETSIZE 0x7fffffffL
/* LONG_MAX fd_set is of type long */
/* I might have misunderstood this so potentially dangerous */
