...
# Copyright (C) 1993, 1994, 1995, 1996, 1997, 1998, 1999, 2000, 2001, 2002, mv
...
srcdir='.'
CC='gcc'
CFLAGS='-D_POSIX_SOURCE -D_SUSV2_SOURCE -D_BSD_EXTENSION -D_RESEARCH_SOURCE -D_REENTRANT_SOURCE -D_C99_SNPRINTF_EXTENSION -D_LIMITS_EXTENSION -D_REGEXP_EXTENSION -D_NET_EXTENSION'
CPPFLAGS=''
LDFLAGS='-L/386/lib/gnu'
ALLOCA=''
LOADLIBES=' '
