...
/* 
 * Copyright (c) 1998,99,2000,01,02,03,04,06,08,09 David Stes
 *
...
#define OBJCVERSION "3.2.11"
#define OBJC1VERSION "objc3.2.11"
...
{
  printf("Portable Object Compiler %s (c) 1997,2011.\n",OBJCVERSION);
...
void setfirstlinetag(void)
{
  ...
  if (o_gnu) {
    ...
    definebuiltinfun("__builtin_va_start");
