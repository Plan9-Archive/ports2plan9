...
/* Plan9 hacks: */
/*manual defines of stuff that somehow does not get defined in the headers. Some may be bad approximations */
#define EALREADY EADDRINUSE
/* later APEs will fix this... */
#ifndef EISCONN
